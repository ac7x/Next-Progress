import { CreateWarehouseItemProps, CreateWarehouseProps, UpdateWarehouseItemProps, UpdateWarehouseProps, Warehouse, WarehouseItem } from '../../domain/entities';
import { IWarehouseItemRepository, IWarehouseRepository } from '../../domain/repositories';
import { WarehouseItemService as DomainWarehouseItemService, WarehouseService as DomainWarehouseService } from '../../domain/services';
import { WarehouseInstanceRepository, warehouseItemRepository } from '../../infrastructure/repositories';
