...
export const GlobalBottomNav = () => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-[var(--background)] border-t border-gray-200 z-50">
      <div className="max-w-7xl mx-auto">
        <ul className="flex justify-around items-center h-16">
          <li>
            <Link
              href="/client/dashboard_management"
              className="flex flex-col items-center p-2 text-[var(--foreground)] hover:text-blue-600"
            >
