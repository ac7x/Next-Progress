...
import { ProjectInstanceDetails } from './project-instance-details';
            ...
            {projectInstances.map((projectInstance) => (
              <>
                <tr key={projectInstance.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {tasksDetailsMap
                      ? `${tasksDetailsMap[projectInstance.id]?.equipmentCount ?? 0} / ${tasksDetailsMap[projectInstance.id]?.actualEquipmentCount ?? 0}`
                      : '—'}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
