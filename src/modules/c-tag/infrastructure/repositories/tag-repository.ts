// src/modules/c-tag/infrastructure/repositories/tag-repository.ts
import { prisma } from '@/modules/c-shared/infrastructure/persistence/prisma/client';
import { CreateTagProps, Tag, TagType, UpdateTagProps } from '@/modules/c-tag/domain/entities/tag-entity';
import { ITagRepository } from '@/modules/c-tag/domain/repositories/tag-repository-interface';
import { tagAdapter } from '../adapter/tag-adapter';
